...
const DESTINATION_IP = "192.168.2.134";
...
//   if (universe === 2) {
//     for (let i = 0; i < 144; i++) {
//       sender.prepChannel(i + 144, data[i]);
//     }
//   }
...
const reciever = dmxnet.newReceiver({
  subnet: 0, //Destination subnet, default 0
  universe: 1, //Destination universe, default 0
  net: 0, //Destination net, default 0
});
reciever.on("data", (data) => {
  // console.log("recieved artnet", data);
  // onRecieveArtnet(i, data);
  for (let i = 0; i < data.length; i++) {
    sender.prepChannel(i, data[i]);
  }
